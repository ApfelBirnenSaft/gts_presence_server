...
class EmployeeAudit(db.Model):
    __tablename__ = 'employees' + '_audit'
    ...
    def __init__(self, audit_id:int, audit_action:AuditAction, audit_datetime: DateTime, audit_issuer_id:Optional["int"], prefix:str, first_name:str, last_name:str, short_name:str, password:str, sec_lvl:int, password_change_recomended: bool,
