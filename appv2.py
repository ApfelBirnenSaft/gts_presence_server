...
if __name__ == "__main__":
    socketio.run(app, host = Secrets.server_host_v2, port = Secrets.server_port, debug = True)#, ssl_context=('certificate/server.crt', 'certificate/private.key'))#, use_reloader=False)